select dt,
    ...
    count(distinct case when eventid = 'app_start' then udid else null end) as pcid_dau,
...
where  dt >= '20180105' and dt <= '20180106' and parameters['new_device_tag'] = 'Y'
    and eventid in ('event_clientshow','play','app_start')
